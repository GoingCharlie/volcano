...
type ServerOption struct {
	...
	// Actions override the ordered action pipeline. Plugins select the
	// capability set, in priority order.
...
func (s *ServerOption) AddFlags(fs *pflag.FlagSet) {
	...
	fs.StringSliceVar(&s.Plugins, "repack-plugins", nil,
		"Repack capability plugin set, in priority order (default: workloadscope,pdbconstraint,repackbudget,nodeconsolidation,networktopologyaware,workloaddisruption,gangdisruption,binpack)")
