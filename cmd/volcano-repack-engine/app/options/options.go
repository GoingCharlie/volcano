...
func (s *ServerOption) AddFlags(fs *pflag.FlagSet) {
	...
	fs.StringSliceVar(&s.Plugins, "repack-plugins", nil,
		"Repack capability plugin set; input order does not affect behavior (default: workloadscope,pdbaware,repackbudget,nodeconsolidation,workloaddisruption,gangdisruption,binpack)")
