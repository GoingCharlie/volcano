...
const (
	...
	// defaultExecuteCooldown is the default cooldown; keep
...
func (s *ServerOption) AddFlags(fs *pflag.FlagSet) {
	...
	fs.DurationVar(&s.ExecutionTimeout, "repack-execution-timeout", defaultExecutionTimeout, "Maximum duration for the complete Execute lifecycle")
